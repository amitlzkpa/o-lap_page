...
function updatePts() {
	...
	add_highback_y = Design_A.inputState["high-back"] ? 120 : 0;
	add_highback_z = Design_A.inputState["high-back"] ? 40 : 0;

	add_weight_out_y = map_range(Design_A.inputState["weight"], Design_A.inputs.weight.min, Design_A.inputs.weight.max, 0, 90);
	add_weight_in_y = map_range(Design_A.inputState["weight"], Design_A.inputs.weight.min, Design_A.inputs.weight.max, 0, 60);

	add_age_z = map_range(Design_A.inputState["age"], Design_A.inputs.age.min, Design_A.inputs.age.max, 0, 80);
